...
func InitMysqlClient(clientName, username, password, host, dbName string) error {
	...
	if err != nil {
		return fmt.Errorf("host : %s,err:%s", host, err.Error())
	}
